# Tasks: Corregir instalación de dependencias del backend en Docker
...
- [x] Reproducir el fallo actual de build o arranque del backend en Docker.
...
- [ ] Alinear el healthcheck operativo entre backend y probes del despliegue.
