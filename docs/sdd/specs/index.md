...
| [Ordenar y Compactar Docs & AI en Detalle de Vehículo](./2026-05-16-vehicle-docs-ai-responsive-tidy/spec.md) | In Progress | refactor/ui | 2026-05-16 | Compacta el contexto del vehículo y reorganiza `Ask` para reducir scroll y desorden, sobre todo en móvil. |
| [Overhaul de Docs & AI](./2026-05-16-docs-ai-overhaul/spec.md) | In Progress | refactor/ui | 2026-05-16 | Reestructura `Docs & AI` para corregir layout, mejorar jerarquía y alinearlo con `system.md` en desktop y móvil. |
